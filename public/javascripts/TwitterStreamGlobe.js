(function () {
    ...
    function addEarth () {
        ...
        uniforms['texture'].value = THREE.ImageUtils.loadTexture('/images/global-chart-circumnavigation.jpg');
    ...
    function addBeacon (position, tweet) {
        ...
        beacon.position.x = ((1500/360.0) * (180 + position.x));
        beacon.position.y = ((1500/180.0) * (90 + position.y));
